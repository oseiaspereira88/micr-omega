...
const evolutionSlotsSchema = z
  .object({
    small: evolutionSlotSchema.optional(),
    medium: evolutionSlotSchema.optional(),
    large: evolutionSlotSchema.optional(),
    macro: evolutionSlotSchema.optional(),
  })
  .partial()
  .optional();
